...
| [Release 0.3.9](operations/release-0.3.9.md) | Workflow definition snapshots, instance version pinning, admin definition governance, token-based approvals, and notification scoping. |
